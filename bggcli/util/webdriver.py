...
class WebDriver:
    ...
    def create_local_firefox_driver(self, profile_path):
        ...
        gecko = "/opt/homebrew/bin/geckodriver"
        # browser = webdriver.Firefox(firefox_binary=gecko, firefox_options=options)
        # browser = webdriver.Firefox(executable_path=gecko, firefox_options=options)
        from selenium.webdriver.firefox.firefox_binary import FirefoxBinary

        path = '/Users/fdenzer/Downloads/_/Firefox.app/Contents/MacOS/firefox-bin'
        binary = FirefoxBinary(path)
        browser = webdriver.Firefox(firefox_binary=binary, firefox_options=options)
